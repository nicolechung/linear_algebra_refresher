...
ell1 = Line(normal_vector=Vector(['7.204', '3.182']), constant_term='1.21')
ell2 = Line(normal_vector=Vector(['8.172', '4.114']), constant_term='3.025')
print ('intersection 1:', ell1.intersection_with(ell2))

ell1 = Line(normal_vector=Vector(['1.182', '5.562']), constant_term='1.21')
ell2 = Line(normal_vector=Vector(['1.773', '8.343']), constant_term='3.025')
print ('intersection 1:', ell1.intersection_with(ell2))